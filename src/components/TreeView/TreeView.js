...
const CustomLabel = ({ color, expandable, children, ...other }) => {
...
const TreeView = () => {
  return (
    <Card
      variant="outlined"
      sx={{ display: 'flex', flexDirection: 'column', gap: '8px', flexGrow: 1, borderRadius: '16px', border: 'none', boxShadow: 'rgba(145, 158, 171, 0.2) 0px 0px 2px 0px, rgba(145, 158, 171, 0.12) 0px 12px 24px -4px;' }}
    >
      <CardContent>
